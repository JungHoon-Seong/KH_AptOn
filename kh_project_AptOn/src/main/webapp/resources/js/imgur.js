...
(function (root, factory) {
    ...
    Imgur.prototype = {
        ...
        loading: function () {
            ...
            img = this.createEls('img', {className: 'loading-image', src: 'resources/img/loading-spin.svg'});
...
var feedback = function(res) {
    ...
    if (res.success === true) {
        ...
        var content =
            'Image : ' + '<br><input name="image" class="image-url" value=\"' + get_link + '\"/>' 
...
new Imgur({
    clientid: '13958676dad4c4a', //You can change this ClientID
    callback: feedback
});
