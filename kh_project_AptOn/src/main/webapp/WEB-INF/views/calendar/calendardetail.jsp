...
<legend>일정 정보</legend>
  <div>
    ...
    <c:forEach items="${calendarlist}" var="calendar">
      ...
      <li><input type="text" class="datepicker" id="startdate" autocomplete="off" value="${calendar.calendar_startdate}">
      ...
      <li><input type="text" class="datepicker" id="enddate" autocomplete="off" value="${calendar.calendar_enddate}" readonly></li>
    </ul>
    
  </div>
  <div id="divinput">
    <input type="text" value= "${calendar.calendar_title}" id="title">
  </div>
 
</fieldset>
<button onclick="cancle();"id="cancle" class="enrollbtn">취소하기</button>
<button onclick="deletedata();" id="delete"class="enrollbtn">삭제하기</button>
<button onclick="modifydata();" id="modify"class="enrollbtn">수정하기</button>
</section>
<script type="text/javascript">
function deletedata(){
	var calendarnum = ${calendar.calendar_num};
